...
(function () {
    ...
    const STR = {
        ...
        'settings.update.latest': { zh: '当前为优化版 v3.34', en: 'Design refinement v3.34', tw: '當前為優化版 v3.34', ja: '最適化版 v3.34', ko: '최적화 버전 v3.34', th: 'เวอร์ชันปรับปรุง v3.34', vi: 'Bản tối ưu v3.34', ms: 'Versi dipertingkat v3.34', id: 'Versi penyempurnaan v3.34', fil: 'Pinahusay na bersyon v3.34' },
