...
(function () {
    ...
    const STR = {
        ...
        'settings.update.latest': { zh: '当前为优化版 v3.41', en: 'Design refinement v3.41', tw: '當前為優化版 v3.41', ja: '最適化版 v3.41', ko: '최적화 버전 v3.41', th: 'เวอร์ชันปรับปรุง v3.41', vi: 'Bản tối ưu v3.41', ms: 'Versi dipertingkat v3.41', id: 'Versi penyempurnaan v3.41', fil: 'Pinahusay na bersyon v3.41' },
    ...
    const I18N = {
        ...
        setLang(code, persist) {
            ...
            // v3.41 修复：applyStatic 是 I18N 的方法，此前裸调用抛 ReferenceError，
